...
<head>
  ...
  <script>
    ...
    window.CONFIG.APP_VERSION = {{ config('app.version', 0x020000) }};
    window.CONFIG.APP_VERSION_STR = "{{ config('app.version_str', '2.0.0') }}";
    window.CONFIG.REVERB_APP_KEY = "{{ config('broadcasting.connections.reverb.key') }}";
    window.CONFIG.REVERB_HOST = "{{ config('broadcasting.connections.reverb.options.host') }}";
    window.CONFIG.REVERB_PORT = "{{ config('broadcasting.connections.reverb.options.port') }}";
    window.CONFIG.REVERB_SCHEME = "{{ config('broadcasting.connections.reverb.options.scheme', 'https') }}";
    window.CONFIG.WEBPUSH_PUBLIC_KEY = "{{ config('webpush.vapid.public_key') }}";
