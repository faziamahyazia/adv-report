...
Route::middleware([Auth::class])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::post('notifications/push-unsubscribe', [NotificationController::class, 'pushUnsubscribe'])->name('admin.notification.push-unsubscribe');
        ...
        Route::prefix('settings')->group(function () {
            ...
            Route::post('reminders/wa/trigger-demo-plot', [ReminderSettingController::class, 'triggerDemoPlot'])->name('admin.reminder.trigger-demo-plot');
